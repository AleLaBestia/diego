  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      let tl = gsap
        ...
        .to(
          textRef.current[0],
          { xPercent: -50, yPercent: -30, left: "50%", top: "30%" },
          0
        )
        .to(
          textRef.current[1],
          { xPercent: -50, yPercent: -60, left: "50%", top: "60%" },
          0
        )
        .to(
          textRef.current[2],
          { xPercent: -50, yPercent: -80, left: "50%", top: "90%" },
          0
        )
